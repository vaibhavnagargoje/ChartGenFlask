...
const BarChartHandler = {
    ...
    generateBarChartHTML: function(chartConfig, chartTitle, description, additionalInfo, chartFilterColumn, chartFilterOptions, selectedFilterValue, preFilteredData) {
        return `
<!DOCTYPE html>
<html>
<head>
